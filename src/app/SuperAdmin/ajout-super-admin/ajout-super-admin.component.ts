...
@Component({
  selector: 'app-ajout-super-admin',
  templateUrl: './ajout-super-admin.component.html',
  styleUrls: ['./ajout-super-admin.component.css']
})
export class AjoutSuperAdminComponent {
